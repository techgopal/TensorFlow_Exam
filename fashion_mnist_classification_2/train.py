...
from fashion_mnist_classification_2 import data_processing, model as m
...
def train_model(file_name):
    ...
    model.summary()
    print("Train Model")
    model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=5, callbacks=[cp_callback, es_callback])
